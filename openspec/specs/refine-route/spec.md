...
Defines the behaviour of the `POST /api/refine` server route — validation, streaming, error handling, and security constraints for the prompt-refinement endpoint.
