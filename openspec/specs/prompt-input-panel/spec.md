# Spec: prompt-input-panel

## Purpose

Defines the behaviour of the client-side prompt input panel — the `PromptInput` component (textarea, live counts, Refine/Use example/Clear controls, keyboard submission) and the `ResultView` empty-state placeholder.
